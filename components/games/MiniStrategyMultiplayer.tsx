...
/**
 * Mini Strategy - Multiplayer Edition
 * Competitive quick strategy puzzles
 */
...
interface StrategyQuestion {
    id: string
    content: { scenario: string; goal: string }
    options: string[]
    correctAnswer: number
    points: number
}

export default function MiniStrategyMultiplayer() {
    ...
    if (gameState === GameState.SETUP) {
        return <PlayerSetupLobby onStartGame={handleStartGame} gameName="Mini Strategy Battle" />
    }
...
interface MiniStrategyPlayerSideProps {
    state: PlayerGameState
    onAnswer: (answerIndex: number) => void
    playerColor: string
}

function MiniStrategyPlayerSide({ state, onAnswer, playerColor }: MiniStrategyPlayerSideProps) {
