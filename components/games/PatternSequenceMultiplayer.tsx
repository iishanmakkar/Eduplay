...
/**
 * Pattern Sequence - Multiplayer Edition
 * Competitive visual pattern completion
 */
...
export default function PatternSequenceMultiplayer() {
    ...
    if (gameState === GameState.SETUP) {
        return <PlayerSetupLobby onStartGame={handleStartGame} gameName="Pattern Master Battle" />
    }
...
interface PatternSequencePlayerSideProps {
    state: PlayerGameState
    onAnswer: (answerIndex: number) => void
    playerColor: string
}

function PatternSequencePlayerSide({ state, onAnswer, playerColor }: PatternSequencePlayerSideProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6 shadow-lg">
                <div className="text-sm text-gray-600 mb-4 text-center">
                    Pattern {state.currentIndex + 1} of {state.questions.length}
                </div>
