...
/**
 * Strategy Builder - Multiplayer Edition
 * Competitive complex strategy puzzles
 */
...
interface StrategyQuestion {
    id: string
    content: { scenario: string; goal: string; options: string[] }
    correctAnswer: number
    points: number
}

export default function StrategyBuilderMultiplayer() {
    ...
    const handlePlayerAnswer = (side: PlayerSide, answerIndex: number) => {
        ...
        const currentQuestion = state.questions[state.currentIndex] as StrategyQuestion
    ...
    if (gameState === GameState.SETUP) {
        return <PlayerSetupLobby onStartGame={handleStartGame} gameName="Strategy Builder Battle" />
    }
...
interface StrategyBuilderPlayerSideProps {
    state: PlayerGameState
    onAnswer: (answerIndex: number) => void
    playerColor: string
}

function StrategyBuilderPlayerSide({ state, onAnswer, playerColor }: StrategyBuilderPlayerSideProps) {
