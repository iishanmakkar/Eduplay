...
exports.genBinaryBlaster = genBinaryBlaster;
exports.genCyberShield = genCyberShield;
exports.genDebugDuel = genDebugDuel;
exports.genLogicGateGarden = genLogicGateGarden;
exports.genInventorsWorkshop = genInventorsWorkshop;
exports.genOlympiadQualifier = genOlympiadQualifier;
exports.genCriticalThinkersCourt = genCriticalThinkersCourt;
exports.genShabdkoshSprint = genShabdkoshSprint;
exports.genVarnamalaVillage = genVarnamalaVillage;
exports.genVyakaranWarrior = genVyakaranWarrior;
exports.genForceMotionDojo = genForceMotionDojo;
exports.genShopItUp = genShopItUp;
...
function genBinaryBlaster() { return genFromPool(BINARY_FACTS, '💻'); }
const CYBER_FACTS = [
...
function genCyberShield() { return genFromPool(CYBER_FACTS, '🔐'); }
const DEBUG_FACTS = [
...
function genDebugDuel() { return genFromPool(DEBUG_FACTS, '🐛'); }
const LOGIC_GATE_FACTS = [
...
function genLogicGateGarden() { return genFromPool(LOGIC_GATE_FACTS, '🧮'); }
// ── GK GAMES ──────────────────────────────────────────────────────────────────
const INVENTOR_FACTS = [
...
function genInventorsWorkshop() { return genFromPool(INVENTOR_FACTS, '🌟'); }
const GENERAL_KNOWLEDGE_FACTS = [
...
function genOlympiadQualifier() { return genFromPool(GENERAL_KNOWLEDGE_FACTS, '🏆'); }
function genCriticalThinkersCourt() {
    const LOGIC_FACTS = [
...
function genShabdkoshSprint() { return genFromPool(HINDI_VOCAB_FACTS, '📚'); }
const VARNAMALA_FACTS = [
...
function genVarnamalaVillage() { return genFromPool(VARNAMALA_FACTS, '🌺'); }
const VYAKARAN_FACTS = [
...
function genVyakaranWarrior() { return genFromPool(VYAKARAN_FACTS, '✍️'); }
// ── SCIENCE (remaining) ───────────────────────────────────────────────────────
const FORCE_FACTS = [
...
function genForceMotionDojo() { return genFromPool(FORCE_FACTS, '🌊'); }
...
function genShopItUp() { return genFromPool(FINANCE_FACTS, '🛒'); }
