...
export function genSynonymSwitchblade(): GenQuestion { return genFromPool(SYNONYM_FACTS, '⚔️') }

const GRAMMAR_FACTS: Fact[] = [
...
export function genGrammarGladiator(): GenQuestion { return genFromPool(GRAMMAR_FACTS, '⚔️') }

const IDIOM_FACTS: Fact[] = [
...
export function genIdiomHunter(): GenQuestion { return genFromPool(IDIOM_FACTS, '🏹') }

const COMPREHENSION_FACTS: Fact[] = [
...
export function genComprehensionCodebreaker(): GenQuestion { return genFromPool(COMPREHENSION_FACTS, '📖') }

// ── SCIENCE GAMES ─────────────────────────────────────────────────────────────

const PERIODIC_FACTS: Fact[] = [
...
export function genPeriodicBattleship(): GenQuestion { return genFromPool(PERIODIC_FACTS, '⚗️') }

const ANIMAL_FACTS: Fact[] = [
...
export function genAnimalKingdomSorter(): GenQuestion { return genFromPool(ANIMAL_FACTS, '🦁') }

const SOLAR_FACTS: Fact[] = [
...
export function genSolarSystemDefender(): GenQuestion { return genFromPool(SOLAR_FACTS, '🔭') }

const GENETICS_FACTS: Fact[] = [
...
export function genGeneticsGenomeDuel(): GenQuestion { return genFromPool(GENETICS_FACTS, '🧬') }

const FOOD_CHAIN_FACTS: Fact[] = [
...
export function genFoodChainArena(): GenQuestion { return genFromPool(FOOD_CHAIN_FACTS, '🍎') }

const PLANT_FACTS: Fact[] = [
...
export function genPlantPowerGrower(): GenQuestion { return genFromPool(PLANT_FACTS, '🌱') }

// ── SOCIAL STUDIES GAMES ──────────────────────────────────────────────────────

const WORLD_CAPITALS_FACTS: Fact[] = [
...
export function genCapitalsConquest(): GenQuestion { return genFromPool(WORLD_CAPITALS_FACTS, '🌍') }

const WORLD_FLAGS_FACTS: Fact[] = [
...
export function genWorldFlags(): GenQuestion { return genFromPool(WORLD_FLAGS_FACTS, '🌍') }
...
export function genCivilizationBuilder(): GenQuestion { return genFromPool(HISTORY_FACTS, '🏛️') }

export function genEmpireFall(): GenQuestion { return genFromPool(HISTORY_FACTS, '🏰') }
